  ...
  "zh-CN": {
    translation: {
      ...
      accounts: {
        ...
        detectAllDescription: "将对每个已启用且状态正常的 Grok Build 账号发起一次 grok-4.5 探测请求（hello,test）。探测会消耗上游额度；已确认失效（凭据被拒 / spending-limit / 聊天端点拒绝）的账号会标为失效并增量列出。",
        detectSelectedTitle: "检测所选 {{count}} 个 Grok Build 账号？",
        detectSelectedDescription: "将对所选账号逐一发起 grok-4.5 探测请求（hello,test）。结果会实时显示可用 / 失效 / 失败；已确认失效的账号会标为 reauth。",
        detectAll: "开始检测",
        detectProgressLabel: "检测进度",
        detectInvalidCount: "已发现 {{count}} 个失效账号",
        detectSelectedSummary: "可用 {{ok}} · 失效 {{invalid}} · 失败 {{failed}}",
        detectWaitingInvalid: "检测进行中，失效账号会实时出现在下方…",
        detectWaitingResults: "检测进行中，结果会实时出现在下方…",
        detectNoInvalid: "本次未发现失效账号",
  ...
  en: {
    translation: {
      ...
      audits: {
        ...
        search: "Search request ID, model, account, or egress node",
        request: "Request",
        route: "Route",
        status: "Status",
        mode: "Mode",
      ...
      apiErrors: {
        ...
        accountDetectFailed: "Failed to detect Grok Build accounts",
